...
run_all_tests(ProgramToTest) :-
    ...
    all_valid_ok(['valid_test.txt','valid000.txt','valid001.txt','valid002.txt','valid004.txt','valid005.txt',
...
'valid987.txt','valid999.txt']),
    all_invalid_ok(['invalid_test.txt','invalid007.txt','invalid009.txt','invalid013.txt','invalid015.txt','invalid017.txt',
